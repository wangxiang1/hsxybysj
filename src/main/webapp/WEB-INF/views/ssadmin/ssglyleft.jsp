...
<body style="background:#f0f9fd;">
    ...
    <span><img src="<%=path %>/js/model/images/leftico01.png" /></span>管理水电费信息
    	...
    	<ul class="menuson">
        <li class="active"><cite></cite><a href="<%=path %>/hsxy/sdjf/ssadmin/gossglymain" target="rightFrame">首页</a><i></i></li>
        <li><cite></cite><a href="<%=path %>/hsxy/sdjf/ssadmin/gosdfsj?page=0&sslh=&ssh=&sfjf&date=" target="rightFrame">水电费数据表</a><i></i></li>
        </ul>    
    </dd>
    ...
    <ul class="menuson">
        <li><cite></cite><a href="<%=path %>/hsxy/sdjf/ssadmin/yhxx?page=0&bz=1" target="rightFrame">用户信息</a><i></i></li>
    </ul>     
    </dd> 
    ...
    <ul class="menuson">
        <li><cite></cite><a href="<%=path %>/hsxy/sdjf/ssadmin/goglyxgmm" target="rightFrame">修改密码</a><i></i></li>
    </ul>    
    </dd> 
    </dl>
</body>
