...
<body style="background:url(<%=path %>/js/model/images/topbg.gif) repeat-x;">
    ...
    <ul class="nav">
	  ...
	  <%--   <li><a href="#"><img src="<%=path %>/js/model/images/icon02.png" title="模型管理" /><h2>模型管理</h2></a></li>
	    <li><a href="#"><img src="<%=path %>/js/model/images/icon03.png" title="模块设计" /><h2>模块设计</h2></a></li>
	    <li><a href="#"><img src="<%=path %>/js/model/images/icon04.png" title="常用工具" /><h2>常用工具</h2></a></li>
	    <li><a href="#"><img src="<%=path %>/js/model/images/icon05.png" title="文件管理" /><h2>文件管理</h2></a></li>
	    <li><a href="#"><img src="<%=path %>/js/model/images/icon06.png" title="系统设置" /><h2>系统设置</h2></a></li> --%>
    </ul>
