...
<body>
    ...
    <div class="tools">
    	<ul class="toolbar">
        <li class="addstu"><span><img src="<%=path %>/js/model/images/t01.png" /></span>添加</li>
        <li class="updatestu" onclick="updateStu()"><span><img src="<%=path %>/js/model/images/t02.png" /></span>修改</li>
        <li class="deletestu"><span  onclick="delAllStuAjax()"><img src="<%=path %>/js/model/images/t03.png" /></span>删除</li>
        </ul>
       <%--  <ul class="seachform">
        <li>
	      <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;学号</label>
	      <input id="dlzh" name="" type="text" class="scinput" />
	    </li>
	    <li>
	      <label>宿舍楼号</label>
	      <c:if test="${sslh == '' }">
	    ...
	    <li>
		    ...
		    <div class="vocation" style="border: 1px solid #C7C7C7; width: 60px; height: 30px;">
		   		 <select id="xb" style="width: 58px; height: 28px;">
    ...
    <table class="tablelist">
    	<thead>
    	<tr>
	        <th><input id="stualldel" type="checkbox" onchange="studelall()" /></th>
	        <th>学号</th>
	        <th>姓名</th>
	        <th>性别</th>
	        <th>学历</th>
        ...
        <c:forEach items="${students }" var="s" varStatus="i">
	        <tr>
	            <td>
	               <input id="studel${i.index }" name="stubox" class="stubox1" type="checkbox" value="${s.stuid }" />
    ...
    <div class="tools">
    	<ul class="toolbar">
        <li class="addgly"><span><img src="<%=path %>/js/model/images/t01.png" /></span>添加</li>
        <li class="updategly" onclick="updateGly()"><span><img src="<%=path %>/js/model/images/t02.png" /></span>修改</li>
        <li class="deletegly" onclick="delAllGlyAjax()"><span><img src="<%=path %>/js/model/images/t03.png" /></span>删除</li>
        </ul>
    </div>
